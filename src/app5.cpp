...
int main(int argc, char *argv[])
{
  ...
  m_floor.Specular(0);
  m_floor.SetPattern((ray_lib::Pattern *)&p_floor);
  floor.Mat(m_floor);
  ...
  middle_mat.SetPattern((ray_lib::Pattern *)&p_mat);
  ...
  right_mat.SetPattern((ray_lib::Pattern *)&p_rightmat);
  ...
  left_mat.SetPattern((ray_lib::Pattern *)&p_leftmat);
